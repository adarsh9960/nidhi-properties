...
import { ShieldCheck, Building2, Star, Calendar, MapPin, ArrowRight } from 'lucide-react';
    ...
    <section id="about" className="py-24 px-6 md:px-12 lg:px-16 bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <AnimatedHeading
            as="h2"
            text={"About NP (Nidhi Properties)\n30+ Years of Real Estate Trust."}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-24">
          <FadeIn duration={900} direction="right" distance={30} className="lg:col-span-7 relative">
            <div className="relative rounded-2xl overflow-hidden border border-white/10 group shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 liquid-glass p-6 rounded-xl border border-white/10 backdrop-blur-md transition-all duration-300 group-hover:border-white/20">
          ...
          <FadeIn duration={900} delay={200} direction="left" distance={30} className="lg:col-span-5 flex flex-col justify-center space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              {stats.map((stat, index) => (
                <FadeIn key={index} delay={300 + index * 100} direction="up" distance={15}>
                  <div className="liquid-glass p-4 rounded-xl border border-white/10 hover:border-white/30 transition-all duration-300 group hover:-translate-y-1">
                    <div className="text-2xl md:text-3xl font-normal text-white mb-1 group-hover:scale-105 transition-transform">{stat.value}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {pillars.map((pillar, idx) => (
            <FadeIn key={idx} delay={idx * 150} duration={800} direction="up" distance={25}>
              <div className="liquid-glass p-8 rounded-2xl border border-white/10 hover:border-white/25 transition-all duration-300 group h-full flex flex-col justify-between hover:-translate-y-1.5 shadow-xl">
                <div>
                  <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-white/20 transition-all duration-300">
                    {pillar.icon}
                  </div>
