...
export const PropertiesMaladWest: React.FC = () => {
  const meta = SEO_PAGES_META["/properties-in-malad-west"];
    ...
    <div className="min-h-screen bg-black text-white pt-28 pb-16 px-4 md:px-12 lg:px-16 selection:bg-white selection:text-black">
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <nav className="flex items-center gap-2 text-xs text-gray-400">
          ...
          <span>/</span>
          <span className="text-gray-200">Properties in Malad West</span>
        </nav>
          ...
          <div className="relative z-10 max-w-3xl space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full liquid-glass border border-white/20">
              ...
              <span className="text-xs uppercase tracking-widest font-semibold text-gray-200">
                IT & Commercial Hub • Malad West Real Estate
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <a href="tel:+919820000000" className="bg-white text-black px-6 py-3.5 rounded-xl font-medium text-sm hover:bg-gray-100 transition-all flex items-center gap-2">
                ...
                <span>Contact NP Malad Advisor</span>
              </a>
              <Link to="/commercial-property-kandivali-west" className="liquid-glass border border-white/25 px-6 py-3.5 rounded-xl font-medium text-sm hover:bg-white hover:text-black transition-all flex items-center gap-2">
                <span>View Commercial Spaces</span>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="liquid-glass p-6 rounded-2xl border border-white/10 space-y-2">
            ...
            <p className="text-xs text-gray-400">Major corporate IT hub with high demand for rental residential apartments.</p>
          </div>
          <div className="liquid-glass p-6 rounded-2xl border border-white/10 space-y-2">
            <h3 className="text-lg font-medium text-white flex items-center gap-2">
              <MapPin className="w-4 h-4 text-emerald-400" />
            ...
            <p className="text-xs text-gray-400">Prime residential township featuring wide roads, shopping plazas, and luxury towers.</p>
          </div>
          <div className="liquid-glass p-6 rounded-2xl border border-white/10 space-y-2">
            <h3 className="text-lg font-medium text-white flex items-center gap-2">
              <MapPin className="w-4 h-4 text-emerald-400" />
            ...
            <p className="text-xs text-gray-400">High-growth commercial retail belt connecting Malad West to Kandivali West.</p>
          </div>
        </section>
      </div>
    </div>
